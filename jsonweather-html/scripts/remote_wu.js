...
(function () {
    ...
    function getData(lat, long) {
        var url = "scripts/weather.json"; //change this to the correct URL for wunderground
...
jQuery(document).ready(function($) {
    $.ajax({
        url : "http://api.wunderground.com/api/ba98fbce1faceef0/geolookup/conditions/q/IA/Cedar_Rapids.json",
        dataType : "jsonp",
